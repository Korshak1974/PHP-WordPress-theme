    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-11 col-sm-12 col-md-12 col-lg-3">
                ...
                <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/logo.svg"  class="footer__logo-img">
                    <div class="footer__logo-text">Пушечные лендинги</div>
                </div>
            </div>
            <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                <div class="header__contacts">
                    ...
                    <div class="header__contacts-item">
                        ...
                        <a href="<?php the_field('address', 2) ?>"><?php the_field('address', 2) ?></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <ul class="header__nav">
                <li>
                    <a class="header__nav-item" href="http://localhost/mysite/">Главная</a>
                </li>
                <li>
                    <a class="header__nav-item" href="http://localhost/mysite/nasha-komanda/">Наша команда</a>
                </li>
                <li>
                    <a class="header__nav-item" href="http://localhost/mysite/soft_toys/">Наши работы</a>
                </li>
                <li>
                    <a class="header__nav-item" href="http://localhost/mysite/o-nas/">О нас</a>
                </li>
                <li>
                    <a class="header__nav-item" href="http://localhost/mysite/nasha-istoriya/">Наша история</a>
                </li>
                <li>
                    <a class="header__nav-item" href="http://localhost/mysite/kontakty-i-otzyvy/">Контакты и отзывы</a>
                </li>
            </ul>
