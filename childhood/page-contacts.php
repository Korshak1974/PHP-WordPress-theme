            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                            Мы находимся в Минске, метро "Каменная Горка", в деловом центре "Ракета", второй этаж
                            <br> <br>
                            по адресу <address href="<?php the_field('address', 2) ?>"><?php the_field('address', 2) ?></address>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="<?php the_field('telephone', 2) ?>"><?php the_field('telephone', 2) ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts_feed">
                           <?php echo do_shortcode('[contact-form-7 id="185" title="Форма отзывов"]') ?>
                        </div>
                         </div>
                                ...
                                <ul class="glide__slides">
                                    <li class="glide__slide">
                                        ...
                                        <div class="feedslider__text">
                                         Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga delectus harum minus quae necessitatibus nemo similique ipsum nostrum sunt. Dolorem?
                                            <br><br>
                                    ...
                                    <li class="glide__slide">
                                        ...
                                        <div class="feedslider__text">
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores, molestiae! Deserunt aut impedit debitis cupiditate saepe magnam nisi nam laborum?
                                        </div>
                                    </li>
                                    <li class="glide__slide">
                                        <div class="feedslider__title">
                                        ...
                                        <div class="feedslider__text">
                                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iusto illo tempore quam aperiam similique ipsa velit nihil saepe provident voluptatem.
                                        </div>
                                    </li>
                                </ul>
                            </div>
